...
> **Note:** This tool only pulls historical weather data for the previous day or earlier. It does not report current-day weather because daily data may be incomplete.
